...
* [Core](#core-special-interest-group-core-special-interest-group)
...
To see the list of closed SIGs and WGs, check the [archive](https://github.com/kyma-project/community/tree/master/collaboration/archive).
...
* Follow the official project guidelines defined in the [**Contributing rules**](/contributing/#contributing-rules-contributing-rules) repository.
...
## Close a SIG or WG
When a SIG or WG has completed its goals or there is an explicit request to conclude further work, it has to be closed. The request to close a SIG or WG may come from group members, group leaders, Kyma community or Kyma Steering Committee. To close a SIG or WG, group leaders need to:
