...
>
> For reference, see the existing **Tutorials** document concerning the [Sample service deployment on local machine](https://kyma-project.io/docs/root/kyma/#tutorials-sample-service-deployment-on-a-cluster).
