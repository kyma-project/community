...
To copy the image to our registry, modify the [external-images.yaml](https://github.com/kyma-project/test-infra/blob/main/cmd/image-syncer/external-images.yaml) file.
