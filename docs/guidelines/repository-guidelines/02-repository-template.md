...
* [`REUSE.toml`](https://github.com/kyma-project/template-repository/blob/main/REUSE.toml) - This folder includes a file with the copyright and licensing disclaimer about SAP or third-party products or services developed outside the project.
