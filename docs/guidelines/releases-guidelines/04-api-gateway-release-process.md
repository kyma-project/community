...
8. [Configure Dependabot](https://github.com/kyma-project/api-gateway/blob/35f3201a442a332b4b78467af13e46db7b8dfe7b/.github/dependabot.yml#L25) to watch the release branch if a new one was created.
