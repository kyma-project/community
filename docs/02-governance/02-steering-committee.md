...
The committee is open for any contributors, [individual or corporate](../01-contributing/02-contributing.md#agreements-and-licenses). These are the rules we apply:

* In case of individual contributors, you need to be an active [Kyma maintainer](./01-governance.md#process-for-becoming-a-maintainer-aka-codeowner) for at least 2 major components.
