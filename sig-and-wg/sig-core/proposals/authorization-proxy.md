...
>**NOTE:** Read [this](https://github.com/kyma-project/kyma/blob/master/docs/security/docs/02-01-security.md) document first to understand the current authorization concept.
