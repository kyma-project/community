...
| charts/prometheus-istio/values.yaml | alertmanager.enabled: false | [L#33](https://github.com/prometheus-community/helm-charts/blob/main/charts/prometheus/values.yaml#L33) |  | 
| charts/prometheus-istio/values.yaml | kubeStateMetrics.enabled: false | [L#464](https://github.com/prometheus-community/helm-charts/blob/main/charts/prometheus/values.yaml#L464) |  | 
| charts/prometheus-istio/values.yaml | nodeExporter.enabled: false | [L#474](https://github.com/prometheus-community/helm-charts/blob/main/charts/prometheus/values.yaml#L474) |  | 
| charts/prometheus-istio/values.yaml | server.enableServiceLinks: false | [L#684](https://github.com/prometheus-community/helm-charts/blob/main/charts/prometheus/values.yaml#L684) |  | 
| charts/prometheus-istio/values.yaml | server.global.scrape_interval: 30s | [L#739](https://github.com/prometheus-community/helm-charts/blob/main/charts/prometheus/values.yaml#L739) |  | 
| charts/prometheus-istio/values.yaml | server.global.evaluation_interval: 30s | [L#745](https://github.com/prometheus-community/helm-charts/blob/main/charts/prometheus/values.yaml#L745) |  | 
| charts/prometheus-istio/values.yaml | server.persistentVolume.enabled: false | [L#895](https://github.com/prometheus-community/helm-charts/blob/main/charts/prometheus/values.yaml#L895) |  | 
| charts/prometheus-istio/values.yaml | server.podAnnotations.sidecar.istio.io/inject: false | n/a |  | 
| charts/prometheus-istio/values.yaml | server.readinessProbeTimeout: 30 | [L#1021](https://github.com/prometheus-community/helm-charts/blob/main/charts/prometheus/values.yaml#L1021) |  | 
| charts/prometheus-istio/values.yaml | server.livenessProbeTimeout: 30 | [L#1026](https://github.com/prometheus-community/helm-charts/blob/main/charts/prometheus/values.yaml#L1026) |  | 
...
| charts/prometheus-istio/values.yaml | server.retention: 2h | [L#1124](https://github.com/prometheus-community/helm-charts/blob/main/charts/prometheus/values.yaml#L1124) |  | 
| charts/prometheus-istio/values.yaml | pushgateway.enabled: false | [L#1129](https://github.com/prometheus-community/helm-charts/blob/main/charts/prometheus/values.yaml#L1129) |  | 
| charts/prometheus-istio/values.yaml | serverFiles.recording_rules.yml | [L#1405](https://github.com/prometheus-community/helm-charts/blob/main/charts/prometheus/values.yaml#L1405) |  | 
...
| values.yaml | defaultRules.rules.kubeApiserverSlos: false | [L#43](https://github.com/prometheus-community/helm-charts/blob/main/charts/kube-prometheus-stack/values.yaml#L43) |  | 
| values.yaml | defaultRules.disabled.CPUThrottlingHigh: true | n/a |  | 
| values.yaml | additionalPrometheusRules: |- | [L#82](https://github.com/prometheus-community/helm-charts/blob/main/charts/kube-prometheus-stack/values.yaml#L82) |  | 
...
| values.yaml | global.rbac.pspEnabled: true | [L#108](https://github.com/prometheus-community/helm-charts/blob/main/charts/kube-prometheus-stack/values.yaml#L108) |  | 
| values.yaml | global.highPriorityClassName: kyma-system-priority | n/a |  | 
| values.yaml | global.alertTools | n/a |  | 
| values.yaml | alertmanager.config is multiline string | [L#164](https://github.com/prometheus-community/helm-charts/blob/main/charts/kube-prometheus-stack/values.yaml#L164) |  | 
| values.yaml | alertmanager.tplConfig: true | [L#190](https://github.com/prometheus-community/helm-charts/blob/main/charts/kube-prometheus-stack/values.yaml#L190) |  | 
| values.yaml | alertmanager.serviceMonitor.scheme: http | [L#381](https://github.com/prometheus-community/helm-charts/blob/main/charts/kube-prometheus-stack/values.yaml#L381) |  | 
| values.yaml | alertmanager.serviceMonitor.metricRelabelings | n/a |  | 
| values.yaml | alertmanager.alertmanagerSpec.resources | n/a |  | 
| values.yaml | alertmanagerSpec.podMetadata.annotations.sidecar.istio.io/inject: false | n/a |  | 
| values.yaml | grafana.defaultDashboardsTimezone | [L#668](https://github.com/prometheus-community/helm-charts/blob/main/charts/kube-prometheus-stack/values.yaml#L668) |  | 
| values.yaml | grafana.rbac.pspEnabled: true | [L#675](https://github.com/prometheus-community/helm-charts/blob/main/charts/kube-prometheus-stack/values.yaml#L675) |  | 
...
| values.yaml | kubeControllerManager.enabled: false | [L#999](https://github.com/prometheus-community/helm-charts/blob/main/charts/kube-prometheus-stack/values.yaml#L999) |  | 
| values.yaml | coreDns.enabled: false | [L#1064](https://github.com/prometheus-community/helm-charts/blob/main/charts/kube-prometheus-stack/values.yaml#L1064) |  | 
| values.yaml | kubeEtcd.enabled: false | [L#1161](https://github.com/prometheus-community/helm-charts/blob/main/charts/kube-prometheus-stack/values.yaml#L1161) |  | 
| values.yaml | kubeScheduler.enabled: false | [L#1228](https://github.com/prometheus-community/helm-charts/blob/main/charts/kube-prometheus-stack/values.yaml#L1228) |  | 
| values.yaml | kubeProxy.enabled: false | [L#1292](https://github.com/prometheus-community/helm-charts/blob/main/charts/kube-prometheus-stack/values.yaml#L1292) |  | 
...
| values.yaml | prometheus-node-exporter.rbac.pspEnabled: true | [L#1453](https://github.com/prometheus-community/helm-charts/blob/main/charts/kube-prometheus-stack/values.yaml#L1453) |  | 
| values.yaml | prometheusOperator.tls.enabled: false | [L#1463](https://github.com/prometheus-community/helm-charts/blob/main/charts/kube-prometheus-stack/values.yaml#L1463) |  | 
| values.yaml | prometheusOperator.admissionWebhooks.enabled: false | [L#1473](https://github.com/prometheus-community/helm-charts/blob/main/charts/kube-prometheus-stack/values.yaml#L1473) |  | 
| values.yaml | admissionWebhooks.patch.podAnnotations.sidecar.istio.io/inject: false | n/a |  | 
...
| values.yaml | prometheusOperator.prometheusConfigReloader.resources.requests.cpu: 100m | [L#1735](https://github.com/prometheus-community/helm-charts/blob/main/charts/kube-prometheus-stack/values.yaml#L1735) |  | 
| values.yaml | prometheusOperator.prometheusConfigReloader.resources.limits.cpu: 100m | [L#1738](https://github.com/prometheus-community/helm-charts/blob/main/charts/kube-prometheus-stack/values.yaml#L1738) |  | 
| values.yaml | prometheus.serviceMonitor.metricRelabelings | n/a |  | 
| values.yaml | prometheus.prometheusSpec.scrapeInterval: 30s | [L#2130](https://github.com/prometheus-community/helm-charts/blob/main/charts/kube-prometheus-stack/values.yaml#L2130) |  | 
| values.yaml | prometheus.prometheusSpec.evaluationInterval: 30s | [L#2138](https://github.com/prometheus-community/helm-charts/blob/main/charts/kube-prometheus-stack/values.yaml#L2138) |  | 
...
| values.yaml | prometheus.prometheusSpec.ruleSelectorNilUsesHelmValues: false | [L#2257](https://github.com/prometheus-community/helm-charts/blob/main/charts/kube-prometheus-stack/values.yaml#L2257) |  | 
| values.yaml | prometheusSpec.serviceMonitorSelectorNilUsesHelmValues: false | [L#2282](https://github.com/prometheus-community/helm-charts/blob/main/charts/kube-prometheus-stack/values.yaml#L2282) |  | 
| values.yaml | prometheusSpec.podMonitorSelectorNilUsesHelmValues: false | [L#2305](https://github.com/prometheus-community/helm-charts/blob/main/charts/kube-prometheus-stack/values.yaml#L2305) |  | 
| values.yaml | prometheus.prometheusSpec.probeSelectorNilUsesHelmValues: false | [L#2325](https://github.com/prometheus-community/helm-charts/blob/main/charts/kube-prometheus-stack/values.yaml#L2325) |  | 
| values.yaml | prometheus.prometheusSpec.retention: 1d | [L#2343](https://github.com/prometheus-community/helm-charts/blob/main/charts/kube-prometheus-stack/values.yaml#L2343) |  | 
| values.yaml | prometheus.prometheusSpec.retentionSize: 2GB | [L#2347](https://github.com/prometheus-community/helm-charts/blob/main/charts/kube-prometheus-stack/values.yaml#L2347) |  | 
| values.yaml | prometheus.prometheusSpec.walCompression: true | [L#2351](https://github.com/prometheus-community/helm-charts/blob/main/charts/kube-prometheus-stack/values.yaml#L2351) |  | 
...
| values.yaml | grafana.serviceMonitor.enabled: false | [L#791](https://github.com/prometheus-community/helm-charts/blob/main/charts/kube-prometheus-stack/values.yaml#L791) |  | 
...
| templates/grafana/dashboards-1.14/k8s-resources-cluster.yaml | Delete device label selector | [L#2907](https://github.com/prometheus-community/helm-charts/blob/main/charts/kube-prometheus-stack/templates/grafana/dashboards-1.14/k8s-resources-cluster.yaml#L2907) |  | 
| templates/grafana/dashboards-1.14/k8s-resources-cluster.yaml | Delete device label selector (2 times) | [L#2916](https://github.com/prometheus-community/helm-charts/blob/main/charts/kube-prometheus-stack/templates/grafana/dashboards-1.14/k8s-resources-cluster.yaml#L2916) |  | 
| templates/grafana/dashboards-1.14/k8s-resources-cluster.yaml | Delete device label selector | [L#2925](https://github.com/prometheus-community/helm-charts/blob/main/charts/kube-prometheus-stack/templates/grafana/dashboards-1.14/k8s-resources-cluster.yaml#L2925) |  | 
| templates/grafana/dashboards-1.14/k8s-resources-cluster.yaml | Delete device label selector | [L#2934](https://github.com/prometheus-community/helm-charts/blob/main/charts/kube-prometheus-stack/templates/grafana/dashboards-1.14/k8s-resources-cluster.yaml#L2934) |  | 
| templates/grafana/dashboards-1.14/k8s-resources-cluster.yaml | Delete device label selector (2 times) | [L#2943](https://github.com/prometheus-community/helm-charts/blob/main/charts/kube-prometheus-stack/templates/grafana/dashboards-1.14/k8s-resources-cluster.yaml#L2943) |  | 
| templates/grafana/dashboards-1.14/k8s-resources-cluster.yaml | Delete device label selector | [L#2928](https://github.com/prometheus-community/helm-charts/blob/main/charts/kube-prometheus-stack/templates/grafana/dashboards-1.14/k8s-resources-cluster.yaml#L2928) |  | 
| templates/grafana/dashboards-1.14/k8s-resources-cluster.yaml | Delete device label selector | [L#2929](https://github.com/prometheus-community/helm-charts/blob/main/charts/kube-prometheus-stack/templates/grafana/dashboards-1.14/k8s-resources-cluster.yaml#L2929) |  | 
| templates/grafana/dashboards-1.14/k8s-resources-cluster.yaml | Delete device label selector | [L#2930](https://github.com/prometheus-community/helm-charts/blob/main/charts/kube-prometheus-stack/templates/grafana/dashboards-1.14/k8s-resources-cluster.yaml#L2930) |  | 
| templates/grafana/dashboards-1.14/k8s-resources-namespace.yaml | Delete device label selector (2 times) | [L#2230](https://github.com/prometheus-community/helm-charts/blob/main/charts/kube-prometheus-stack/templates/grafana/dashboards-1.14/k8s-resources-namespace.yaml#L2230) |  | 
| templates/grafana/dashboards-1.14/k8s-resources-namespace.yaml | Delete device label selector (2 times) | [L#2319](https://github.com/prometheus-community/helm-charts/blob/main/charts/kube-prometheus-stack/templates/grafana/dashboards-1.14/k8s-resources-namespace.yaml#L2319) |  | 
| templates/grafana/dashboards-1.14/k8s-resources-namespace.yaml | Delete device label selector | [L#2580](https://github.com/prometheus-community/helm-charts/blob/main/charts/kube-prometheus-stack/templates/grafana/dashboards-1.14/k8s-resources-namespace.yaml#L2580) |  | 
| templates/grafana/dashboards-1.14/k8s-resources-namespace.yaml | Delete device label selector | [L#2589](https://github.com/prometheus-community/helm-charts/blob/main/charts/kube-prometheus-stack/templates/grafana/dashboards-1.14/k8s-resources-namespace.yaml#L2589) |  | 
| templates/grafana/dashboards-1.14/k8s-resources-namespace.yaml | Delete device label selector (2 times) | [L#2598](https://github.com/prometheus-community/helm-charts/blob/main/charts/kube-prometheus-stack/templates/grafana/dashboards-1.14/k8s-resources-namespace.yaml#L2598) |  | 
| templates/grafana/dashboards-1.14/k8s-resources-namespace.yaml | Delete device label selector | [L#2607](https://github.com/prometheus-community/helm-charts/blob/main/charts/kube-prometheus-stack/templates/grafana/dashboards-1.14/k8s-resources-namespace.yaml#L2607) |  | 
| templates/grafana/dashboards-1.14/k8s-resources-namespace.yaml | Delete device label selector | [L#2616](https://github.com/prometheus-community/helm-charts/blob/main/charts/kube-prometheus-stack/templates/grafana/dashboards-1.14/k8s-resources-namespace.yaml#L2616) |  | 
| templates/grafana/dashboards-1.14/k8s-resources-namespace.yaml | Delete device label selector (2 times) | [L#2625](https://github.com/prometheus-community/helm-charts/blob/main/charts/kube-prometheus-stack/templates/grafana/dashboards-1.14/k8s-resources-namespace.yaml#L2625) |  | 
| templates/grafana/dashboards-1.14/k8s-resources-pod.yaml | Delete device label selector | [L#1668](https://github.com/prometheus-community/helm-charts/blob/main/charts/kube-prometheus-stack/templates/grafana/dashboards-1.14/k8s-resources-pod.yaml#L1668) |  | 
| templates/grafana/dashboards-1.14/k8s-resources-pod.yaml | Delete device label selector | [L#1676](https://github.com/prometheus-community/helm-charts/blob/main/charts/kube-prometheus-stack/templates/grafana/dashboards-1.14/k8s-resources-pod.yaml#L1676) |  | 
| templates/grafana/dashboards-1.14/k8s-resources-pod.yaml | Delete device label selector | [L#1765](https://github.com/prometheus-community/helm-charts/blob/main/charts/kube-prometheus-stack/templates/grafana/dashboards-1.14/k8s-resources-pod.yaml#L1765) |  | 
| templates/grafana/dashboards-1.14/k8s-resources-pod.yaml | Delete device label selector | [L#1773](https://github.com/prometheus-community/helm-charts/blob/main/charts/kube-prometheus-stack/templates/grafana/dashboards-1.14/k8s-resources-pod.yaml#L1773) |  | 
| templates/grafana/dashboards-1.14/k8s-resources-pod.yaml | Delete device label selector | [L#2225](https://github.com/prometheus-community/helm-charts/blob/main/charts/kube-prometheus-stack/templates/grafana/dashboards-1.14/k8s-resources-pod.yaml#L2225) |  | 
| templates/grafana/dashboards-1.14/k8s-resources-pod.yaml | Delete device label selector | [L#2234](https://github.com/prometheus-community/helm-charts/blob/main/charts/kube-prometheus-stack/templates/grafana/dashboards-1.14/k8s-resources-pod.yaml#L2234) |  | 
| templates/grafana/dashboards-1.14/k8s-resources-pod.yaml | Delete device label selector (2 times) | [L#2243](https://github.com/prometheus-community/helm-charts/blob/main/charts/kube-prometheus-stack/templates/grafana/dashboards-1.14/k8s-resources-pod.yaml#L2243) |  | 
| templates/grafana/dashboards-1.14/k8s-resources-pod.yaml | Delete device label selector | [L#2252](https://github.com/prometheus-community/helm-charts/blob/main/charts/kube-prometheus-stack/templates/grafana/dashboards-1.14/k8s-resources-pod.yaml#L2252) |  | 
| templates/grafana/dashboards-1.14/k8s-resources-pod.yaml | Delete device label selector | [L#2261](https://github.com/prometheus-community/helm-charts/blob/main/charts/kube-prometheus-stack/templates/grafana/dashboards-1.14/k8s-resources-pod.yaml#L2261) |  | 
| templates/grafana/dashboards-1.14/k8s-resources-pod.yaml | Delete device label selector (2 times) | [L#2270](https://github.com/prometheus-community/helm-charts/blob/main/charts/kube-prometheus-stack/templates/grafana/dashboards-1.14/k8s-resources-pod.yaml#L2270) |  | 