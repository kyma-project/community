...
* `sig/{SIG_NAME}` indicates [which Special interest group (SIG)](./sig-and-wg/README.md) identified the issue and is responsible for further follow-up of the issue.
* `wg/{WG_NAME}` indicates [which Working group (WG)](./sig-and-wg/README.md) identified the issue and is responsible for further follow-up of the issue.
