...
Because the release notes contain critical information and act as an important communication tool, follow these guidelines so that the documentation is informative and consistent. When authoring release notes, follow the [Style and Terminology](#style-and-terminology-style-and-terminology) for many agreed-upon standards. Read the [instruction](https://github.com/kyma-project/website/blob/master/docs/write-blog-posts.md) to learn how to add the release notes as a blog post on a website.
