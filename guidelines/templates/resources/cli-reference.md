...
For reference, see the existing document for the [Service Catalog](https://kyma-project.io/docs/main/components/service-catalog/#cli-reference-cli-reference).
